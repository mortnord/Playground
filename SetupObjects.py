...
def create_rutabaga():  # Denne koden returnerer en ny kålrabi, dette gjør at koden for å endre en kålrabi kun er 1 plass
    return InventoryObject(RawFoodObject(0.1, "Rutabaga", TypeOfObject.Food, Veggies, 5, Icons.Rutabaga.value), 0,0)


def create_carrot(): #  Samme som ovenfor, bare gulrot
    return InventoryObject(RawFoodObject(0.1, "Gulrot", TypeOfObject.Food, Veggies, 3, Icons.Carrot.value),0,0)
