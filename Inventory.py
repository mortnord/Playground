...
class Inventory:
    def __init__(self):
        ...
        self.inventory_contents_sprite_list = arcade.SpriteList()  # Lag liste over hva innhold i inventory som skal tegnes
    ...
    def append_to_inventory(self, object_to_append):  # Hva vi kaller for å legge items til, først vil den legge til ting
